...
export function GuestRank() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-warm-100 text-warm-600">
        Loading...
      </div>
    );
  }
  ...
  if (error || !data) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-warm-100 p-4">
  ...
  return (
    <div className="min-h-screen bg-warm-100 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-lg text-gray-600">
            {hostName ? `${hostName} needs` : "We need"} your help planning the
            perfect meal.
          </p>
          <p className="text-sm text-gray-500 mt-1">
            Rate the dishes below so we can create a menu everyone enjoys.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="bg-warm-100 px-4 py-3 border-b border-warm-200">
                  <h3 className="text-lg leading-6 font-medium text-warm-900 capitalize">
                    {category}s
                  </h3>
                </div>
