      ...
      return (
        <div className="min-h-screen bg-warm-50 flex items-center justify-center p-6">
          <div className="max-w-lg w-full bg-white border border-warm-200 rounded-lg shadow p-6">
            <h1 className="text-xl font-bold text-warm-900">Something went wrong</h1>
            <p className="mt-2 text-sm text-gray-600">Open the console for details.</p>
            <pre className="mt-4 text-xs bg-gray-50 border border-gray-200 rounded p-3 overflow-auto">{message}</pre>
            <button
